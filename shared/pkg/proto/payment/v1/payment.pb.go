...
// PaymentMethod определяет доступные способы оплаты.
...
// PayOrderRequest - сообщение запроса для метода PayOrder.
...
// PayOrderResponse - сообщение ответа для метода PayOrder.
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBQZOgithub.com/shenikar/microservices-course/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
